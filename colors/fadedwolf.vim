...
let s:bwc.brightgravel   = ['c3ced9', 252]
let s:bwc.lightgravel    = ['848f99', 245]
let s:bwc.gravel         = ['787f85', 243]
let s:bwc.mediumgravel   = ['626466', 241]
let s:bwc.deepgravel     = ['3b4145', 238]
...
" my desk.
let s:bwc.dalespale = ['3edefa', 221]

" A beautiful tan from Tomorrow Night.
let s:bwc.dirtyblonde = ['86cff4', 222]

" Delicious, chewy red from Made of Code for the poppiest highlights.
let s:bwc.taffy = ['4b2cff', 196]

" Another chewy accent, but use sparingly!
let s:bwc.saltwatertaffy = ['baff8c', 121]
...
" * The cursor
" * A REPL prompt
let s:bwc.tardis = ['1d5385', 39]

" This one's from Mustang, not Florida!
let s:bwc.orange = ['24a7ff', 214]

" A limier green from Getafe.
let s:bwc.lime = ['00b9ae', 154]

" Rose's dress in The Idiot's Lantern.
let s:bwc.dress = ['546fad', 211]

" Another play on the brown from Clouds Midnight.  I love that color.
let s:bwc.toffee = ['5388b8', 137]

" Also based on that Clouds Midnight brown.
let s:bwc.coffee    = ['5b91c7', 173]
let s:bwc.darkroast = ['3f6388', 95]
